  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        className={cn(
          "bg-card fixed z-50 flex flex-col gap-4 shadow-lg inset-shadow-xs  inset-shadow-foreground/20 shadow-background transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
